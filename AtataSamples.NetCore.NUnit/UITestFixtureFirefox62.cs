...
{
    [TestFixture]
    public class UITestFixtureFirefox62
    {
        ...
        public void SetUp()
        {
            var capabilities = new DesiredCapabilities("firefox", "62.0", new Platform(PlatformType.Any));
            ...
            AtataContext.Configure().
                ...
                UseBaseUrl(baseUrl).
                UseWaitingTimeout(new TimeSpan(0, 0, 15)).
                UseNUnitTestName().
